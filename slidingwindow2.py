...
def crop_slide_window(image_path, mask_path, save_folder, size):
    ...
    lower_slide_window = original_image[end + adjusted_slide_height: min(end + adjusted_slide_height + slide_height, size), :]
    ...
    lower_mask_window = original_mask[end + adjusted_slide_height: min(end + adjusted_slide_height + slide_height, size), :]
