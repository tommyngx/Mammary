...
def process_images_and_masks(image_folder, mask_folder, output_folder, resize_to):
...
if __name__ == '__main__':
    ...
    process_images_and_masks(args.image_folder, args.mask_folder, args.output_folder, tuple(args.resize_to) if args.resize_to else None)